...
- **Absolutiste** : 1er monarque absolu, Dernière grande révolte oligarchique (DGRO), Acmé absolutiste, Saturation fiscale, Fiscalité directe établie, Remontrance, Réformes échouées
...
- `Ancien régime` est une sous-phase **seulement** — l'entrée en AR est marquée par le saillant **Saturation fiscale** (critère Lanoue de Suremain), pas par un saillant « Ancien Régime ». Quand c'est au contraire **Fiscalité directe établie** qui s'applique (l'État prélève directement sans qu'aucun corps intermédiaire ne puisse s'y opposer), l'entrée en AR n'a **pas** de marqueur fiscal : elle se date sur les marqueurs de sédimentation, et la sortie endogène de l'AR devient impossible. La Remontrance, quand elle a lieu, est généralement simultanée ou quasi-simultanée à la Saturation fiscale — mais c'est une manifestation politique contingente qui peut être absente.
