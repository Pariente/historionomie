...
- Armée permanente soldée par l'exécutif
- Administration centrale (même embryonnaire)
- Coexistence de l'appareil central avec des pouvoirs locaux encore autonomes
...
**Définition simple** : le moment où le pouvoir central (et la puissance de la nation) est au plus fort pendant la phase oligarchique. Un souverain qui « sort du lot par la puissance de son pouvoir personnel », combinée à la projection extérieure maximale de la nation dans le cadre oligarchique existant. L'acmé se situe typiquement dans l'essor ou au début de la polarisation, mais sa position chronologique varie considérablement selon les cas — ce n'est pas une position fixe dans la phase.

**L'acmé correspond au point de saturation de l'exutoire externe.** Vérification empirique sur le corpus : la fraction de la phase oligarchique où se situe l'acmé (0 = début, 1 = fin) varie de 0.13 (Suisse, ~1512) à 0.71 (Autriche, Léopold Ier ~1683). Le pattern qui se dégage n'est pas une position temporelle fixe mais une corrélation dynamique — **l'acmé arrive quand l'exutoire externe cesse de produire son surplus d'énergie**. Quand l'exutoire est court, l'acmé est précoce (Espagne : Rois Catholiques à 0.36, l'essor maritime et ibérique sature rapidement). Quand l'exutoire est très long, l'acmé est tardif (Venise : Foscari à 0.64 ; Autriche : Léopold Ier à 0.71, porté par l'exutoire anti-ottoman qui relance la projection extérieure au milieu de la polarisation). Les cas sans exutoire prolongé se regroupent autour de 0.45-0.55 (France, Angleterre, Milan, Bavière, Israël — « charnière essor/polarisation »).
...
- Chambre haute représentant les grands seigneurs et oligarques (cœur initial du pouvoir)
- Pouvoir exécutif arbitre entre les oligarques
- Assemblée populaire ou chambre basse (validation de la légitimité populaire)
- Pouvoir judiciaire conçu comme contre-pouvoir, avec souvent une « Cour Suprême »
- Appareil gouvernemental fortement décentralisé, avec au moins un deuxième échelon capable de lever des impôts et de légiférer
- Partis politiques de nature clientéliste

### Marqueurs forts initiaux

- Mise par écrit ou codification légale des rapports de force entre l'exécutif central et les oligarques
- Premières troupes soldées en numéraire par l'exécutif central
- Apparition d'un fisc central, coexistant avec les fiscs oligarchiques locaux
- Polarisation faible des élites (encore majoritairement issues de l'aristocratie de la phase précédente)

### Marqueurs forts en cours de phase

- Fonctionnaires payés en numéraire par l'exécutif central
- L'exécutif acquiert le droit de lever des troupes sur tout le territoire en cas de guerre
- Droit d'appel au chef de l'exécutif pour les membres du corps civique
- Première assemblée des élites prébendières
- Administration parallèle répondant directement à l'exécutif, sans préséance sur les administrations locales
- Formation d'un « conseil privé » au sommet de cette administration parallèle
- L'exécutif développe des contournements juridiques pour s'accaparer de facto la politique extérieure et la gestion militaire

### Marqueurs observables

- Activité militaire accrue
- (Ré)apparition du mercenariat de masse
- Croissance économique

## Sous-phase 2 : Polarisation des élites

Dès que les aventures extérieures cessent de rapporter — par saturation, défaite, ou fermeture des débouchés — la dynamique principale de la nation change. La question n'est plus « comment s'enrichir à l'extérieur ? » mais « **qui contrôle l'État central ?** ». Car l'État a grossi pendant l'essor : il lève des impôts, distribue des charges, structure le commerce, rend la justice. Pour les élites, s'assurer que cet appareil ne soit pas utilisé *contre* elles — et même qu'il soit utilisé *pour* elles — devient la priorité.
...
**Espagne** : la phase oligarchique dure ~345 ans (1369-1714), prolongée par la Reconquista, l'empire colonial américain et le choc d'hétérogénéité habsbourgeois (1516). L'empire colonial prolonge la phase OLIGARCHIQUE (pas l'absolutiste) parce que les fueros aragonais sont encore intacts — le test discriminant absolutiste n'est pas passé à l'échelle nationale.
