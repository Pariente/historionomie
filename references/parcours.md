...
Le modèle historionomique de Philippe Fabry pose qu'une nation se construit en traversant une succession de phases obligées. Deux moteurs alimentent cette progression : la construction de l'État central et l'homogénéisation culturelle de la nation. Plus la nation avance dans son Parcours, plus son État se consolide et plus sa culture s'unifie — les deux phénomènes s'alimentant mutuellement. Inversement, une hétérogénéisation brutale (par conquête, occupation, déportation) peut faire régresser le Parcours à une phase antérieure.

### Les deux moteurs du Parcours

La progression dans le Parcours est portée par deux processus qui se renforcent mutuellement :

- **La construction de l'État central** : émergence puis renforcement d'un appareil administratif, fiscal et militaire central, qui s'impose progressivement face aux pouvoirs locaux.
- **L'homogénéisation culturelle** : unification progressive de la langue, de la religion, du droit, des mœurs et de la conscience nationale sur le territoire.

Ces deux processus sont à la fois les *moteurs* et les *indicateurs* du Parcours. Pour situer une nation dans son Parcours, on observe le degré de centralisation de l'État et le degré d'homogénéité culturelle. Pour comprendre un ralentissement ou une accélération, on cherche ce qui a perturbé l'un ou l'autre.
...
- En **Révolution Nationale**, la question est résolue (pour un temps) par la **subordination du pouvoir administratif à la représentation nationale**. Le corps représenté est significativement élargi par rapport à l'AR absolutiste — une portion importante de la population du cœur de la nation, pas seulement quelques grands seigneurs ou une famille royale — et continue de s'étendre progressivement dans la phase parlementaire, au rythme autorisé par les standards culturels de chaque époque. La citoyenneté est un processus (cf. `phase_parlementaire.md`), pas un point de bascule.
...
| RN | Une représentation nationale significativement élargie (selon les standards de l'époque) | Subordination du pouvoir administratif à cette représentation nationale |
...
- **Sous domination étrangère**, le Parcours continue d'avancer tant que les deux moteurs ne sont pas détruits. Israël progresse sous domination assyrienne, babylonienne, perse, grecque et romaine — seules les destructions institutionnelles majeures provoquent des reboots.
- **Sans unification formelle**, une nation peut avoir un Parcours propre. L'Italie avance dans son Parcours bien avant son unification politique au XIXe siècle.
...
### Taille de la nation et standard géopolitique de l'époque

Le Parcours décrit une dynamique interne à un peuple qui se constitue en nation, mais cette dynamique n'est jamais isolée : elle se déroule dans un environnement où coexistent d'autres nations à divers stades de leur propre Parcours. À chaque époque, il existe une **taille standard d'État** qui concentre l'essentiel de la puissance géopolitique — administrations palatiales à l'âge du Bronze, cités-États dans l'Antiquité gréco-romaine, États territoriaux (quelques centaines de milliers de kilomètres carrés, dizaines de millions d'habitants) à l'époque moderne, probablement super-États (millions de kilomètres carrés, centaines de millions d'habitants) dans la séquence suivante.

Une nation dont la taille correspond au standard de son époque déroule son Parcours sans contrariété structurelle majeure : les deux moteurs (construction de l'État central, homogénéisation culturelle) progressent endogènement, les phases se succèdent dans l'ordre canonique, les perturbations externes produisent les effets documentés (prolongement, accélération, avortement, reboot).

Une nation dont la taille **diverge fortement** du standard de son époque voit sa dynamique contrariée par l'influence disproportionnée des États de taille standard. Deux cas :

**Nation trop petite pour son époque** (cité-État à l'époque des États territoriaux, par exemple). Plusieurs conséquences structurelles :

- **Absolutisme instable.** Chaque famille élitaire en déclin peut appeler une puissance étrangère à son secours pour déstabiliser le pouvoir central. L'absolutisme tend donc à prendre la forme factionnelle informelle plutôt que la forme consolidée (cf. `phase_absolutiste.md`), avec rotation chaotique entre lignages concurrents — la concentration du pouvoir est réelle règne par règne, mais l'instabilité chronique est la signature structurelle de cette configuration.
- **Guerre sociale arbitrée.** Les puissances voisines interviennent pour imposer un cadre de résolution (souvent par pression diplomatique, médiation papale ou impériale, voire intervention militaire). La résolution endogène pure est rare.
- **RN contrariée.** Quand l'AR explose, l'intervention d'un grand voisin est presque inévitable. Deux issues binaires (cf. `phase_rn.md`) : soit la RN est écrasée et les institutions anciennes sont restaurées à l'identique (**RN avortée**) ; soit la RN produit un nouveau cadre institutionnel durable, même sous arbitrage extérieur ou avec saillants compressés (**RN aboutie**). L'occupation étrangère pendant la séquence ne modifie pas l'issue — ce qui compte est l'aboutissement institutionnel final. La phase parlementaire qui suit une RN aboutie dans une nation trop petite tend à être **figée** (corps civique élargi mais fermé, sans mouvement sinistrogyre d'élargissement endogène) plutôt qu'active.

**Enchaînement attendu pour une cité-État trop petite à l'époque des États territoriaux** (pattern typologique — à tester en priorité avant toute hypothèse alternative) :

1. **Phase féodale courte** (~100 ans au lieu de ~200) — la concentration urbaine et l'homogénéité culturelle précoce compriment la coagulation.
2. **Phase oligarchique** éventuellement prolongée — ponctuée de tentatives de stabilisation internes (podestat étranger, capitaine du peuple) qui sont des basculements intra-phase, pas des changements de phase.
3. **Phase absolutiste forme 4** (~150-250 ans) — **absolutisme collectif par consortium oligarchique** : un consortium institutionnalisé de créanciers-actionnaires oligarques capture progressivement les fonctions d'État (fiscalité, administration territoriale, coercition), reste propriété collective des élites, empêche par construction l'émergence d'un exécutif autonome (cf. `phase_absolutiste.md`, forme 4). C'est le pattern attendu pour ce type de cité-État.
4. **Ancien Régime figé** — corps civique fermé (les familles inscrites au registre = la nation politique), absence de dynamique d'élargissement endogène, ajustements intra-patriciens sans ouverture vers la population.
5. **Sortie par choc exogène** — absorption par un État de taille standard plutôt que RN endogène canonique. Les contestations populaires éventuelles (révoltes de rue, jacobins sous influence étrangère) sont soit écrasées, soit captées par une intervention extérieure qui met fin au Parcours endogène.

Chaque étape peut être compressée, perturbée, ou absente — mais la forme typologique est stable. Quand on analyse une cité-État du corpus, l'hypothèse de travail par défaut doit être cet enchaînement, et tout écart doit être documenté comme perturbation ou singularité structurelle justifiée.

**Nation trop grande pour son époque** (empire continental à l'époque des cités-États, par exemple). L'hétérogénéité culturelle excède la capacité d'homogénéisation, les deux moteurs se désalignent, le Parcours stagne ou se fragmente par correction d'échelle. L'empire de Cnut, l'empire carolingien à Verdun, l'empire Plantagenêt en sont des illustrations.

Ce principe n'est pas un paramètre libre à ajuster pour « faire coller » une nation atypique — c'est une dimension structurelle à évaluer objectivement en comparant la superficie et la population de la nation, à l'époque considérée, au standard géopolitique contemporain. Quand l'écart est fort, il faut s'attendre à des saillants canoniques présents mais compressés, à une instabilité chronique des transitions, et à des signatures d'intervention extérieure à chaque nœud du Parcours.

### Comment mapper un nouveau Parcours

La méthode est **bottom-up par marqueurs** (détaillée dans `CLAUDE.md`, Étape 3) : découper l'histoire en tranches séparées par des événements forts, scorer les marqueurs de chaque phase pour chaque tranche, puis construire trois scénarios structurellement divergents et les vérifier. **Aucune comparaison avec un parcours connu au départ** — la comparaison vient en validation tardive seulement, sur les saillants (pas sur le cadrage).

**Ordre des opérations** :

0. **Établir la superficie de référence** — changements territoriaux majeurs codés en noyau + marges, pour identifier les perturbations territoriales indépendamment du cadrage en phases.
1. **Découpage chronologique neutre** (Étape 3a) — 10 à 20 tranches séparées par événements forts (révolutions, guerres, guerres civiles, changements de régime, traités fondateurs). Pas de vocabulaire historionomique.
2. **Scoring des marqueurs par tranche** (Étape 3b) — pour chaque tranche, score 0-5 pour chaque phase (féodale, oligarchique, absolutiste, RN, parlementaire) avec justification listant les marqueurs observés. Test RN spécifique : la tranche précédente porte-t-elle les marqueurs d'Ancien Régime absolutiste ? Sans AR préalable, pas de RN.
3. **Trois scénarios structurellement divergents** (Étape 3c) — hypothèses vraiment différentes, pas variations d'un même découpage.
4. **Vérification de cohérence interne** (Étape 4) :
   - **4a** : saillants canoniques présents, transitions cohérentes, durées dans les normes (ou écarts expliqués), test discriminant à la bonne échelle.
   - **4b** : test événement par événement — pour chaque événement majeur, se demander « *mon interprétation est-elle cohérente ? cet événement pourrait-il être autre chose ?* »
5. **Comparaison tardive avec les saillants du corpus** (Étape 5) — validation saillant par saillant (dates, caractéristiques structurelles), jamais cadrage par récit global.
6. **Scoring final et scénario retenu** (Étape 6).

**Saillants canoniques à identifier** (liste fermée, cf. `CLAUDE.md`) : pacte oligarchique, guerre sociale, 1er monarque oligarchique, 1er monarque absolu (voir `phase_absolutiste.md` pour les formes admises, à épuiser avant de conclure à l'absence), acmés, remontrance, les 7 étapes de la RN, éveil féodal, perturbations. L'ordre d'identification au sein d'un scénario suit la facilité d'observation (pacte et guerre sociale en premier, éveil féodal reconstruit en dernier).

La **phase** d'une tranche est un **résultat** du scoring des marqueurs, pas une hypothèse qu'on cherche à valider.
...
| Phase parlementaire | Très longue (très stable) |
...
- **Piémont** : la phase féodale dure ~197 ans (~1233-~1430) — dans la norme, le Parcours commence par une correction d'échelle (partition de 1233 qui détache le Piémont du comté de Savoie trans-alpin). La phase oligarchique dure ~266 ans (~1430-~1696), allongée par le prolongement de l'occupation française (1536-1559).
...
**Phase technocratique.** Dégénérescence de l'ENP. Le peuple, disposant du pouvoir politique, l'utilise pour participer à la redistribution plutôt que pour y mettre fin (le choix de Bastiat). La taille de l'État et le périmètre de son action augmentent sans cesse. L'administration grossit jusqu'à devenir un Léviathan capable de renverser les décisions de la chambre basse.

**Dominat.** L'administration est devenue si puissante qu'elle *est* le gouvernement de facto. Les lois ne sont plus réellement votées mais décidées par des comités administratifs. C'est structurellement un reboot en Ancien Régime — mais sans nécessairement la figure du monarque absolu.

## Dynamique des élites

La dynamique des élites est un concept transversal qui irrigue toutes les phases du Parcours. Elle est décrite dans `elites.md`.
...
| Ancien Régime | — (interrompu) | -4 à 66 | ~1715-1789 | ~1603-1642 | ~1718-1848 | ~1848-1918 | ~1748-1861 (éclipse 1796-1814) |
| Début de la RN | — | Grande Révolte (66) | 1789 | Guerre civile (1642) | République de Manin (1848) | Eisner (1918) | — (absorbée, 1861) |
