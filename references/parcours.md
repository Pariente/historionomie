# Le Parcours de construction nationale

## Cadre théorique

Le modèle historionomique de Philippe Fabry pose qu'une nation se construit en traversant une succession de phases obligées, alimentée par deux moteurs : la construction de l'État central et l'homogénéisation culturelle. Plus la nation avance, plus son État se consolide et plus sa culture s'unifie — les deux phénomènes s'alimentant mutuellement. Une hétérogénéisation brutale (conquête, occupation, déportation) peut faire régresser le Parcours à une phase antérieure : c'est le mécanisme du **reboot** (cf. `perturbations.md`).

### Les deux moteurs du Parcours

- **Construction de l'État central** : émergence puis renforcement d'un appareil administratif, fiscal et militaire central, qui s'impose progressivement face aux pouvoirs locaux.
- **Homogénéisation culturelle** : unification progressive de la langue, de la religion, du droit, des mœurs et de la conscience nationale sur le territoire.

Ces deux processus sont à la fois les *moteurs* et les *indicateurs* du Parcours. Pour situer une nation, on observe le degré de centralisation de l'État et le degré d'homogénéité culturelle. Pour comprendre un ralentissement ou une accélération, on cherche ce qui a perturbé l'un ou l'autre.
...
Configurations possibles : tout dispositif formellement privé (banque dynastique-familiale, consortium de créanciers institutionnalisé, ordre religieux militaire, compagnie à charte) qui exerce les fonctions étatiques (fiscalité, coercition, administration territoriale, coordination diplomatique, récompense-sanction des élites) constitue l'appareil central au sens historionomique. Cette possibilité doit être tenue en tête lors de l'identification d'une phase oligarchique ou absolutiste : l'absence d'une bureaucratie formellement publique ne signifie pas l'absence d'appareil central, et les tests discriminants des phases s'appliquent à l'appareil fonctionnel quel que soit son habillage juridique.
...
| Oligarchique | Les oligarques + les nouvelles élites (bourgeoisie, administration) | Subordination des réseaux lignagers au pouvoir administratif central |
| Absolutiste | La nation entière (en théorie) — sédimentation des élites | Éclatement de la sédimentation (RN) |
| RN | Une représentation nationale élargie (selon les standards de l'époque) | Subordination du pouvoir administratif à cette représentation |
...
**Révolution Nationale (~25-80 ans).** Phase troublée qui renverse l'ordre absolutiste. Le clivage gauche-droite saute : centre-droit et centre-gauche fusionnent en bloc élitaire qui profite du système, ED et EG convergent en bloc contestataire. Cf. `phase_rn.md`.
- Sous-phases : révolution initiale (Éclatement de l'AR → Expérience parlementaire → Phase aiguë → Moment thermidorien) → impérialisme revanchard → restauration
- Saillants : Éclatement de l'AR, Expérience parlementaire, Phase aiguë, Moment thermidorien, Émergence de l'IR, Restauration, Glorieuse Révolution

**Phase parlementaire — État-nation parlementaire (ENP).** Aboutissement du Parcours. Le pouvoir administratif est subordonné à la représentation nationale ; la chambre basse est la source ultime du pouvoir. Très stable. Cf. `phase_parlementaire.md`.

**Phase technocratique.** Dégénérescence de l'ENP. Le peuple utilise son pouvoir politique pour participer à la redistribution plutôt que pour y mettre fin (choix de Bastiat). L'administration grossit jusqu'à devenir un Léviathan capable de renverser la chambre basse.

**Dominat.** L'administration *est* le gouvernement de facto. Les lois sont décidées par des comités administratifs. Reboot en ancien régime sans nécessairement de figure de monarque absolu.

---

## Sous-phases et bornes

Les **sous-phases** découpent chaque phase en étapes successives pour comprendre la mécanique. Les bornes marquées ⚠️ sont **dynamiques** (basculement de logique, pas un saillant-pivot) ; les autres sont des **saillants canoniques**.
...
1. Une borne est généralement un saillant ou un événement identifiable, jamais une date arrondie. Deux exceptions : essor → polarisation et polarisation → guerre sociale sont des **basculements de dynamique**.
...
- *Pacte oligarchique* : acte par lequel le corps des grands subordonne son pouvoir à un cadre central, lui conférant une stabilité qui survit aux successions — passage du pouvoir-patrimoine au pouvoir-fonction. Codification possible de la transmission ou de l'exercice ; c'est l'effet (pas l'objet codifié) qui est nécessaire. **Test directionnel décisif** : les grands se subordonnent au cadre (pas le centre qui cède aux grands). Cf. `phase_oligarchique.md` §Pacte oligarchique pour la définition complète.
...
- *1er impôt permanent* : première ressource fiscale — ou premier faisceau de ressources — dont l'extraction est appropriée par le cadre central de façon pérenne : consentement-régime (non reconcédé au coup par coup), affectation centrale-publique effective (non capté par des intermédiaires), ampleur régalienne, survie au règne. Le saillant date le **basculement** vers ce régime — qui peut être l'instauration, la pérennisation d'un expédient (gabelle française 1341-43), ou la recentralisation d'un impôt capté (alcabala castillane 1480)
- *1re armée permanente* : première force de coercition dont l'entretien est approprié par le cadre central de façon permanente, déployée comme instrument du centre sur le territoire (test fonctionnel garde/force) et **ancrée dans un appareil qui la rend indépendante de la personne du fondateur** (test d'ancrage institutionnel — l'Armée Noire de Mathias échoue ce test malgré 32 ans d'existence). Rétribution centrale, monétaire ou non. Pour les nations maritimes, la flotte permanente est l'équivalent canonique
...
**RN** :
- *Éclatement de l'AR* : moment d'effondrement de l'ordre ancien, ouverture de la révolution
- *Expérience parlementaire* : tentative initiale de restructurer le pouvoir sur base représentative
- *Phase aiguë* : période la plus violente de la RN, où s'exécutent les radicaux et où s'effondre le compromis initial
- *Moment thermidorien* : retour des modérés après la phase aiguë, restabilisation
- *Émergence de l'IR* : avènement d'une figure d'Impérialiste Revanchard qui rétablit l'ordre et porte la nation par projection extérieure
- *Restauration* : retour de l'ordre ancien après la chute de l'IR (à la fois saillant — le moment — et sous-phase — la durée)
- *Glorieuse Révolution* : événement qui clôt la RN en ancrant définitivement le parlementarisme
...
- La **restauration** admet une dérivation rare *restauration exogène* (sous-phase de RN) : restauration sous occupation par puissance extérieure, sans roman national propre, coalition restreinte. Trois trajectoires de sortie possibles : élargissement vers GR (canonique), reboot en AR exogène composite par choc d'hétérogénéité (pattern Philippe, cf. `perturbations.md` §4.7), ou stabilisation en AR exogène durable si homogénéité faible. Cf. `phase_rn.md` §Dérivation rare : Restauration exogène et `phase_absolutiste.md` §AR exogène pour le détail des trois formes.
...
- **Nation politiquement fragmentée mais culturellement homogène** : la phase progresse par les deux moteurs sans que la centralisation politique unifie un saillant identifiable. Les saillants peuvent exister régionalement sans figure unifiée à l'échelle nationale.
- **Nation sous tutelle étrangère mais Parcours endogène** : les saillants politiques de la nation hôte ne signalent pas le Parcours endogène ; les figures qui le portent peuvent être religieuses, juridiques, institutionnelles plutôt que monarchiques.
- **Saillant institutionnel plutôt que personnel** : un organe collégial peut concentrer le pouvoir sans qu'il y ait de monarque individuel — le saillant existe mais est porté par une institution.

Pour identifier la phase d'une nation fragmentée, on ne peut pas se fier uniquement aux saillants politiques — il faut aussi évaluer le degré d'homogénéité culturelle.
...
| Phase oligarchique | ~200 ans |
| Phase absolutiste | ~200 ans |
| Révolution Nationale | ~25-80 ans |
| Phase parlementaire | Très longue |

Les écarts à ces durées sont toujours significatifs et s'expliquent par une perturbation d'un des deux moteurs (cf. `perturbations.md`) :

- **Choc d'hétérogénéité** (expansion territoriale, conquête imposant intégration) → prolongement de la phase en cours
- **Choc exogène** (invasion, occupation) → reboot, avortement, ou prolongement selon l'effet sur les institutions
...
## Test discriminant et cohérence d'ensemble

**Règle d'or : le test discriminant prime sur les durées.** Ne pas ajuster l'identification des saillants pour obtenir des durées typiques. Appliquer d'abord le test discriminant de chaque transition de phase, puis expliquer les écarts par des perturbations identifiées. Les durées atypiques sont toujours le signal d'une perturbation, pas d'une erreur d'identification. Si une identification a été choisie « parce que les durées collent mieux », c'est un signal d'alarme.

La **cohérence du parcours d'ensemble** (cf. CLAUDE.md, *Critère essentiel*) est le garde-fou : elle garantit que les saillants identifiés s'enchaînent dans l'ordre canonique, que tous les événements importants sont expliqués, et qu'aucune singularité n'est créée pour faire tenir le récit. Les deux travaillent ensemble — l'un priorise les marqueurs structurels sur les durées, l'autre vérifie que l'ensemble tient.

**Trois vérifications transversales** :
1. Le test discriminant a-t-il été appliqué à la **bonne échelle** ? Pour les monarchies composites, l'absolutisme n'est atteint que quand l'administration centrale a préséance sur TOUTES les administrations locales du territoire national.
2. L'expansion a-t-elle été attribuée à la bonne phase ? L'expansion prolonge la phase **EN COURS** au moment où elle commence.
3. La guerre sociale se joue-t-elle à l'**échelle pertinente** ? Si le Parcours est national, la guerre sociale doit opposer des factions à l'échelle nationale.
...
- **Sous domination étrangère** : le Parcours continue d'avancer tant que les deux moteurs ne sont pas détruits. Seules les destructions institutionnelles majeures (effondrement de l'appareil étatique central, déportations massives, intégration forcée) provoquent des reboots.
...
## Taille de la nation et standard géopolitique
...
**Nation trop petite** (cité-État à l'époque des États territoriaux) : absolutisme fragile face aux chocs exogènes (la centralisation peut être réelle mais portée par un appareil sans profondeur — appareil sans relais bureaucratique propre, ou dont le personnel administratif reste trop mince pour survivre au retrait de la figure qui le porte), guerre sociale parfois arbitrée par les voisins, RN contrariée (souvent compressée sous arbitrage extérieur, parfois absorbée plutôt que résolue). Trajectoire fréquente pour une cité-État trop petite : phase féodale courte → phase oligarchique éventuellement prolongée → phase absolutiste sous configuration patricienne (consortium oligarchique institutionnalisé, ou appareil familial-bancaire d'une famille dominante) → ancien régime figé → sortie par choc exogène et absorption. Hypothèse de travail par défaut quand on analyse une cité-État du corpus, à confirmer ou infirmer cas par cas.

**Grammaire révolutionnaire disponible en permanence.** Une petite nation homogène réunit en permanence les trois conditions qui, dans une nation de taille standard, ne convergent qu'en fin de phase absolutiste et produisent alors la RN : (1) un appareil dirigeant dont la chute laisse un **vide constitutionnel**, parce que la petite taille fait que cet appareil est familial et personnel, sans profondeur bureaucratique ; (2) un **corps civique assez dense et homogène pour se reconstituer collégialement en quelques semaines**, disposant d'un répertoire constitutionnel ancien ; (3) des **masses non intégrées immédiatement mobilisables**, concentrées dans la même enceinte, de même langue et de même culte, déjà semi-intégrées par les corps de métier.

Conséquence : dans une cité-État, **tout choc qui retire l'appareil dirigeant déclenche la séquence complète** — chute du prince, refondation collégiale, mobilisation des exclus, reprise en main par les modérés, retour d'un homme fort — et elle se rejoue autant de fois qu'il y a de chocs. Occurrences documentées : Milan 1447-1450 (mort de Filippo Maria Visconti → République Ambrosienne → Sforza), Florence 1494-1512 (expulsion de Pierre de Médicis → Consiglio Maggiore → Savonarole → Soderini → retour médicéen) et de nouveau 1527-1530, révolutions populaires génoises à dogat viager.

**Le mécanisme : l'élargissement instrumental.** Ce qui produit la ressemblance n'est pas un hasard de forme, c'est une contrainte de ressources. Dans une cité-État, une faction élitaire écartée du circuit de distribution n'a qu'un seul allié disponible : le **corps des citoyens**, concentré dans les mêmes murs et culturellement identique à elle. L'enrôler suppose de l'élargir. Toute guerre sociale de cité-État produit donc mécaniquement des épisodes d'élargissement du corps politique, qui ont l'apparence d'une révolution. Mais cet élargissement est **instrumental et réversible** : il dure ce que dure le besoin de son parrain, et il est révoqué dès que la faction adverse reprend la machine. Cas-type florentin : Grand Conseil de ~3 000 *beneficiati* institué en décembre 1494, rétréci au retour des Médicis en 1512, rétabli en 1527, aboli en 1530-1532. Dans une RN, l'élargissement n'est pas un instrument mais le résultat — d'où son irréversibilité.

**Ne pas confondre avec une RN.** Ces épisodes ont la morphologie de la Révolution Nationale sans en avoir la fonction. Le discriminant est unique et binaire : **une RN élargit le corps civique de façon permanente ; un interlude républicain de cité-État ne l'élargit pas.** France 1789 fait passer le corps civique des ordres privilégiés à la nation, sans retour. Florence 1494 conserve l'éligibilité aux *beneficiati* (ascendance officière), identique en 1512, abolie en 1532 ; Milan 1447 restaure le corps communal d'avant les Visconti à l'identique, supprimé en 1450. La séquence se rejoue, le corps ne bouge pas — c'est pourquoi ces épisodes n'ont aucun effet sur le Parcours et ne doivent être codés ni en RN, ni en saillant canonique.

Plus généralement, **une nation petite par rapport au standard de son époque risque d'être perturbée par des ingérences étrangères** — chaque faction interne en déclin peut faire appel à une puissance voisine pour se relever, ce qui produit des boucles d'instabilité que l'on peut prendre à tort pour des défauts intrinsèques de la trajectoire endogène. Ces ingérences sont des perturbations exogènes qui relèvent de `perturbations.md` §4.2 (choc exogène), pas une signature inhérente à la phase en cours.
...
Ce principe n'est pas un paramètre libre à ajuster pour faire coller une nation atypique — c'est une dimension structurelle à évaluer en comparant la superficie et la population au standard contemporain.

## Superficie de référence (noyau + marges)

Pour chaque nation, la **superficie de référence** se décompose en :
- **Noyau territorial** : territoire culturellement homogène avec le cœur de la nation (même langue, même droit). C'est le territoire qui *est* la nation.
- **Marges** : territoires hétérogènes sous contrôle de la même couronne. C'est le territoire que la nation *possède* sans l'avoir assimilé.

Le noyau est défini par l'homogénéité culturelle, pas par le contrôle politique. Un territoire peut transiter de marge à noyau quand l'homogénéisation y est accomplie — moment souvent marqué par un acte juridique d'intégration (codification linguistique, abolition de spécificités juridiques, fusion administrative).

Les expansions territoriales (chocs d'hétérogénéité) prolongent la phase en cours ; les contractions (corrections d'échelle) l'accélèrent. Le ratio marges/noyau indique la charge d'hétérogénéité qui pèse sur le Parcours. Pour le format de codage dans les fichiers de nations, voir `methode_collecte.md`.

---

## Le clivage gauche-droite (Fabry & Portal)

Le clivage gauche-droite est défini structurellement, indépendamment de toute époque ou de tout lieu. Il vaut pour la guerre sociale, l'AR absolutiste, la RN, et la phase parlementaire. Quatre positions selon le rapport à la « nouvelle donne » (la distribution actuelle des places au centre du pouvoir) :

- **Extrême-droite (ED)** : réactionnaires, grands perdants nostalgiques de l'ancien ordre. Radicaux parce qu'ils « font la queue sans places ».
- **Droite** : conservateurs, préservent la stabilité en ralentissant les changements. Habitués à négocier les places.
- **Gauche** : réformateurs, pensent que réformer pour contenter l'EG maintient la stabilité. Nouveaux entrants demandant leur quota.
- **Extrême-gauche (EG)** : révolutionnaires, encore exclus, prêts à renverser la table.

**Fondement structurel (Fabry)** : le clivage est une expression de l'**homogénéisation divergente**. Le corps civique se structure selon deux axes — social (élites / classes populaires) et spatial (cœur / marges). La gauche se forme des élites des marges ; la droite des classes populaires du cœur. Le mouvement temporel d'intégration est **sinistrogyre** (nouveaux entrants à gauche, dérive vers le centre puis vers la droite).

En **RN, le clivage se replie** : centre-droit et centre-gauche fusionnent en bloc élitaire ; ED et EG convergent en bloc contestataire. Cf. `phase_rn.md`.

---

## Renvois

- **Cartographie d'un nouveau Parcours** — procédure multi-agent : `methode_cartographie.md`
- **Dynamique des élites** — concept transversal : `elites.md`
- **Perturbations** (mécanismes × effets, exutoire) : `perturbations.md`

<!-- Le tableau récapitulatif des saillants par nation est dans `corpus_recapitulatif.md` (lu par le parent uniquement, interdit à Agent 2 pour empêcher l'ancrage par analogie). Pour le détail par nation, voir `references/nations/*/parcours.md` et `references/nations/*/justification.md`. -->
