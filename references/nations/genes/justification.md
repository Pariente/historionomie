...
**Pour.** La Casa di San Giorgio (fondée 23 avril 1407 ; transferts territoriaux à partir de 1446 et surtout 1453 — Corse, Caffa, Famagouste, Lunigiana) exerce *de jure* fonctions souveraines sur les territoires soumis : extraction fiscale, justice, administration territoriale. Gouvernance par les *partecipanti* (créanciers-actionnaires) collectivement, indépendante des doges en exercice. C'est précisément la signature du « appareil d'extraction unifié tenu par une corporation de créanciers » au sens de phase_absolutiste.md §Configurations rencontrées. Sources : Heers, Felloni, Fratianni, Taviani, Winter.
...
**Recensement du corpus** (14 nations, révisé le 2026-07-30). Dix présentent une Remontrance attestée : France (Grandes Remontrances 1753), Angleterre (Apology of the Commons 1604), Venise (Correzione 1761), Bavière (Landtag 1848), Piémont (Révolte 1821), Milan (République Ambrosienne 1447), Hongrie (dissolution diète 1811), Suisse (Société Helvétique 1761), Autriche (1848), Israël prolongement (Ambassade à Auguste -4). Quatre en sont privées : Espagne (Gloriosa écartée le 2026-07-30 — voie armée, exécutif renversé, redistribution durable de six ans ; le carlisme n'est pas substituable, ED mais réclamant un exécutif plus pur, pas la collégialité), Israël antique (phase interrompue par Josias en -609 avant maturité), Florence, Gênes.
...
- **Gênes** n'a **aucun corps distinct de l'exécutif**. Ce que la lecture antérieure appelait « manque du pôle sommet » était mal posé : le corps existe et est dense (Liber aureus, Grand et Petit Conseil, Sénat, Procuratori, protettori de San Giorgio), mais tous ces organes sont ceux du patriciat gouvernant lui-même — les protettori sortent du même Liber nobilitatis que les magistrats. Un veto suppose deux parties ; il n'y en a qu'une. D'où l'absence conjointe de Remontrance et de Saturation fiscale, par une cause unique. Motif révisé le 2026-08-22.
...
| 1er MA | Cosme Ier (1537) — figure dynastique ; lecture Laurent 1480 écartée en août 2026 | Inquisiteurs d'État (~1669) — organe collégial autonome | Ottone Visconti (1277) — figure dynastique | **Andrea Doria (1528) — appareil d'extraction unifié tenu par une corporation de créanciers** |
...
- Les quatre 1er MA prennent quatre formes matérielles distinctes — la liste de « configurations » de phase_absolutiste.md ayant été supprimée en août 2026 parce qu'elle servait à classer au lieu de tester (cf. §La forme matérielle de l'appareil ne classe rien) rencontrées : Florence familial-bancaire (Médicis), Venise organe collégial autonome (Inquisiteurs d'État), Milan figure dynastique (Visconti), **Gênes appareil d'extraction unifié tenu par une corporation de créanciers (Doria + alberghi + Banco San Giorgio)**. Le corpus des cités-États italiennes recouvre ainsi quatre des cinq configurations connues, ce qui valide la typologie comme grille empirique solide.
...
- **Appareil d'extraction unifié tenu par une corporation de créanciers** — configuration documentée dans phase_absolutiste.md §Configurations rencontrées ; trait empirique décisif (faction perdante reste créancière du consortium) confirmé par recherche complémentaire (Heers, Felloni, Fratianni, Taviani, Winter).
