...
- *Remontrance* : structurellement absente — pas de contestation institutionnelle de classe administrative formée pendant l'AR (la Toscane n'a pas de parlement absolutiste comme la France ou de Commons comme l'Angleterre). Florence rejoint le pattern Venise/Gênes : pas de Remontrance canonique identifiable. La transition impérialisme → AR se fait par épuisement dynastique et déclin économique sous Cosme III, sans saillant institutionnel-contestataire.
