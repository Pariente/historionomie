...
1. **Impérialisme absolutiste 1555-1670 (115 ans) sans impérialisme après Sienne — résolu le 2026-08-22, ce n'était pas un trou.** La sous-phase d'impérialisme est une **tendance de la phase, pas une obligation** : une nation empêchée de projeter par un contexte géopolitique défavorable n'aura pas d'impérialisme effectif, et c'est une contingence normale (cf. `phase_absolutiste.md` §Dater l'entrée en AR quand la Saturation est absente). La Toscane cesse toute expansion à Sienne en 1555, coincée entre Habsbourg d'Espagne et papauté, mais elle **n'est pas sclérosée pour autant** : Livourne port franc prospère, Ferdinand Ier mène une diplomatie active, l'Accademia del Cimento est fondée en 1657, Galilée travaille sous protection médicéenne. Une société vivante et productive, simplement privée de débouché extérieur.

   **La borne de 1670 est donc bien fondée, mais pas pour la raison qui était écrite.** Elle ne vaut pas comme date dynastique commode : elle vaut parce que l'avènement de Cosme III ouvre la première attestation de la **sédimentation** — bigoterie et lois somptuaires, surfiscalité, déclin économique et démographique, fermeture de la vie de cour, épuisement dynastique. C'est l'état de la société qui date l'AR, et il ne se dégrade qu'à partir de là. Il n'y a donc pas à faire descendre la borne vers 1609 ou 1620 : la fermeture de la projection extérieure et la sédimentation sont deux phénomènes distincts, séparés ici par un siècle.

2. **Saturation fiscale — résolue le 2026-08-21, requalifiée en Fiscalité directe établie.** Le codage « 1774-1775, Tassa di redenzione » était inversé : la *tassa di redenzione* unifie les charges foncières en un impôt direct et permanent destiné à éteindre la dette, elle **passe**, et la dette est quasi épuisée en 1790. Or la Saturation est définie par une tentative qui *échoue* devant un corps conservant la fonction d'assiette. La Toscane n'a aucun corps de ce type : les communautés du dominio, seuls médiateurs entre le souverain et le contribuable, ont été privées de leurs finances et de leurs statuts par les Nove Conservatori dès 1560. Le saillant devient donc **Fiscalité directe établie** (critère Deblonde, cf. `phase_absolutiste.md`). Conséquences assumées : l'entrée en AR (1670) perd son marqueur fiscal et reste conventionnelle, et la sortie endogène devient structurellement impossible — ni saturation, ni ruine financière — ce qui explique l'AR de 137 ans terminé par le choc exogène de 1807. Le paradoxe à retenir : c'est le marqueur qui qualifie Florence comme absolutiste, la perte de l'autonomie fiscale des entités décentralisées, qui lui interdit d'en sortir par elle-même.
